...
== `canary_scheduler_controller.resources`

[horizontal]
type:: dictionary
defaults:: https://github.com/appuio/component-openshift4-slos/blob/master/class/defaults.yml[See `class/defaults.yml`]

This parameter allows users to customize the resource requests and limits of the scheduler-canary controller container.
